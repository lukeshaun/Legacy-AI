  ...
  return (
    <nav className="w-full md:w-64 bg-card border-r border-border p-6 flex flex-col gap-8">
      <div className="flex items-center gap-3 px-2">
        <img alt="Legacy AI" className="w-14 h-14 object-contain rounded-xl bg-card border border-border" src="/lovable-uploads/2f34731b-6047-4403-a807-edf5d23cadad.jpg" />
